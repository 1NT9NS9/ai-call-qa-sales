    ...
    def test_stage3_happy_path_is_stable_for_pgvector_backed_retrieval(self) -> None:
        ...
        try:
            with temporary_postgres_database("stage3_t8") as database_url:
                ...
                first_matches = app.state.rag_service.search_for_call(call_id=call_id, limit=3)
                second_matches = app.state.rag_service.search_for_call(call_id=call_id, limit=3)
